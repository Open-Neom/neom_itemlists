...
// import 'app_item_details_controller.dart';
//
// class AppItemDetailsPage extends StatelessWidget {
//
//   const AppItemDetailsPage({Key? key}) : super(key: key);
//
//   @override
...
//         return true;
//       },
//       child: GetBuilder<AppItemDetailsController>(
//       id: AppPageIdConstants.appItemDetails,
//       init: AppItemDetailsController(),
//       builder: (_) => Scaffold(
//         appBar: AppBarChild(),
...
//                       SizedBox(width: 200, child: _.appItem.imgUrl.isEmpty ? const Text("") : Image.network(_.appItem.imgUrl)),
//                       AppTheme.heightSpace20,
